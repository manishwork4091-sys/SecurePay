...
// IMPORTANT: Replace the placeholder configuration with your own Firebase project credentials.
// You can find these in your Firebase project settings.
// It's recommended to use environment variables to store these sensitive keys.
const firebaseConfig = {
  ...
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:123456789012:web:XXXXXXXXXXXXXXXXXXXXXX"
};
